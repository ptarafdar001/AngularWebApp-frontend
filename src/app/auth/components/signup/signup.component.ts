...
export class SignupComponent implements OnInit {
  ...
  onSignup(){
    ...
    // }
    if(this.signUpForm.valid && this.signUpForm.value.password==this.signUpForm.value.retypePassword && this.signUpForm.value.email!="admin007@gmail.com"){
      ...
      validateform.validateAllFileds(this.signUpForm);
      if(this.signUpForm.value.email=="admin007@gmail.com"){
        this.chck=true;
